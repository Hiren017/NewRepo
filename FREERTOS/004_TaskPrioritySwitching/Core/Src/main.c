...
volatile BaseType_t button = 0;
TaskHandle_t LEDONHandle;
TaskHandle_t LEDOFFHandle;
BaseType_t status;
...
extern SEGGER_UART_init(uint32_t);
/* USER CODE END PFP */
...
int main(void)
{
  ...
  status = xTaskCreate(LED_Off_handler,"Task-2",200,NULL,3,&LEDOFFHandle);
